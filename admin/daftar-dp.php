...
$getdata = query("SELECT pemain.id AS idPemain, pemain.*, nomor_punggung.*, size.* FROM pemain JOIN nomor_punggung ON pemain.id_no_punggung = nomor_punggung.id JOIN size ON pemain.id_size = size.id WHERE pemain.status_bayar = 'dp'");
$i = 1;
?>
<style>
    body {
...
<div class="container">
    <h3 class="text-gold text-center mt-5 bg-dark p-2 rounded">DAFTAR DP PRE-ORDER JERSEY</h3>
            ...
            <tbody>
                <?php foreach ($getdata as $data) : ?>
                    <tr class="text-center">
                        ...
                        <td class="text-gold"><a href="data-pembeli-dp.php?id=<?= $data['idPemain'] ?>">Klik Disini</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
